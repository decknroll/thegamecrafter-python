...
from thegamecrafter import responses
...
# class TheGameCrafterResponseTestCase(TestCase):
#     def test_provides_resource(self):
#         resource = dict(id=123456)
#         response = fake_response({'resource': resource})
#         obj = responses.TheGameCrafterResponse(response, MagicMock())
...
#     @patch('thegamecrafter.responses.requests.request')
